  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
        ...
        <Route path="/EvaluationSettings" element={<ProtectedRoute requiredPermission="MANAGE_EVALUATIONS"><Evaluations /></ProtectedRoute>} />
        <Route path="/EvaluationQuestionSettings" element={<ProtectedRoute requiredPermission="MANAGE_EVALUATIONS"><QuestionEvaluation /></ProtectedRoute>} />
        <Route path="/EvaluationFormationSettings" element={<ProtectedRoute requiredPermission="MANAGE_EVALUATIONS"><FormationSuggestions /></ProtectedRoute>} />

        {/* Gestion des utilisateurs */}
        <Route path="/user-management" element={<ProtectedRoute requiredPermission="CREATE_USERS"><UserManagement /></ProtectedRoute>} />
        <Route path="/users-list" element={<ProtectedRoute requiredPermission="VIEW_USERS"><UsersList /></ProtectedRoute>} />
        <Route path="/roles-management" element={<ProtectedRoute requiredPermission="MANAGE_ROLES"><RolesManagement /></ProtectedRoute>} />
        <Route path="/permissions-management" element={<ProtectedRoute requiredPermission="MANAGE_PERMISSIONS"><PermissionsManagement /></ProtectedRoute>} />

        {/*CARRIERE */}
        <Route path="/carriere" element={<ListSalaryPage />} />
        <Route path="/carriere/creation" element={<ProtectedRoute requiredPermission="MANAGE_CAREER"><CreationCareerPlan /></ProtectedRoute>} />
        <Route path="/carriere/fiche/:registrationNumber" element={<CareerProfilePage />} />
        <Route path="/carriere/fiche/edit/:CareerPlanId" element={<ProtectedRoute requiredPermission="MANAGE_CAREER"><EditAffectation /></ProtectedRoute>} />
        <Route path="/carriere/fiche/detail/:CareerPlanId" element={<DetailAssignment />} />

        {/*Gestion retraite */}
        <Route path="/retraite" element={<ProtectedRoute requiredPermission="MANAGE_RETIREMENT"><RetirementPage /></ProtectedRoute>} />
