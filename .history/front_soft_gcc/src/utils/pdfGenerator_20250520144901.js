 ...
 * @param {Boolean} forPreview - Si true, retourne l'URL du PDF pour la prévisualisation au lieu de le télécharger
 * @returns {String} Nom du fichier généré ou URL du PDF pour la prévisualisation
 */
export const downloadEvaluationPDF = (
  ...
  if (forPreview) {
    // Génère une URL de blob pour la prévisualisation
