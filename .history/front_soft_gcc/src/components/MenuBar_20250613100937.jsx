...
function MenuBar() {
  ...
  const activeLinkStyle = {
    backgroundColor: 'rgba(255, 214, 0, 0.15)', // Jaune léger
    borderLeft: '4px solid #A020F0', // Pourpre
    color: '#A020F0' // Pourpre
  };
            ...
            <ul className="nav flex-column sub-menu">
              <li className="nav-item">
                <Link 
                  ...
                  to="/carriere"
                  style={isActiveLink('/carriere') ? {color: '#A020F0', fontWeight: '600'} : {}}
                >
                  Plan de carrière
                </Link>
              </li>
              <li className="nav-item">
                <Link 
                  ...
                  to="/retraite"
                  style={isActiveLink('/retraite') ? {color: '#A020F0', fontWeight: '600'} : {}}
                >
              ...
              <li className="nav-item">
                <Link 
                  ...
                  style={isActiveLink('/softGcc/souhaitEvolution/suivi') ? {color: '#A020F0', fontWeight: '600'} : {}}
                >
            ...
            <ul className="nav flex-column sub-menu">
              <li className="nav-item"> 
                <Link 
                  ...
                  style={isActiveLink('/softGcc/attestationManagement/list') ? {color: '#A020F0', fontWeight: '600'} : {}}
                >
              ...
              <li className="nav-item"> 
                <Link 
                  ...
                  style={isActiveLink('/softGcc/settings/carriere') ? {color: '#A020F0', fontWeight: '600'} : {}}
                > 
              ...
              <li className="nav-item"> 
                <Link 
                  ...
                  style={isActiveLink('/softGcc/settings/employeeManagement/liste') ? {color: '#A020F0', fontWeight: '600'} : {}}
                > 
            ...
            <ul className="nav flex-column sub-menu">
              <li className="nav-item"> 
                <Link 
                  ...
                  to="/salary-list"
                  style={isActiveLink('/salary-list') ? {color: '#A020F0', fontWeight: '600'} : {}}
                >
              ...
              <li className="nav-item"> 
                <Link 
                  ...
                  to="/planning"
                  style={isActiveLink('/planning') ? {color: '#A020F0', fontWeight: '600'} : {}}
                > 
              ...
              <li className="nav-item"> 
                <Link 
                  ...
                  to="/homeInterview"
                  style={isActiveLink('/homeInterview') ? {color: '#A020F0', fontWeight: '600'} : {}}
                > 
              ...
              <li className="nav-item"> 
                <Link 
                  ...
                  to="/history"
                  style={isActiveLink('/history') ? {color: '#A020F0', fontWeight: '600'} : {}}
                > 
            ...
            <ul className="nav flex-column sub-menu">
              <li className="nav-item"> 
                <Link 
                  ...
                  style={isActiveLink('/softGcc/settings/competence') ? {color: '#A020F0', fontWeight: '600'} : {}}
                >
                  Gestion Compétences
                </Link>
              </li>
              ...
              <li className="nav-item"> 
                <Link 
                  ...
                  style={isActiveLink('/EvaluationSettings') ? {color: '#A020F0', fontWeight: '600'} : {}}
                > 
              ...
              <li className="nav-item"> 
                <Link 
                  ...
                  to="/user-management"
                  style={isActiveLink('/user-management') ? {color: '#A020F0', fontWeight: '600'} : {}}
                > 
