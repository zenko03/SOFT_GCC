...
function FormationSuggestions() {
    ...
    const handleEdit = (suggestion) => {
        ...
        const matchingQuestion = questions.find(q => parseInt(q.questiondId || q.QuestiondId || q.questionId || q.QuestionId || 0, 10) === questionIdFromSuggestion);
        ...
        if (!matchingQuestion && questionIdFromSuggestion !== 0) {
            ...
            console.log("IDs disponibles:", questions.map(q => parseInt(q.questiondId || q.QuestiondId || q.questionId || q.QuestionId || 0, 10)));
        }
