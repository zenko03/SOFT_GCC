                                    ...
                                    <Table>
                                        ...
                                        <TableBody>
                                            {questions.map((question, index) => (
                                                <TableRow key={question.questionId || question.questiondId}>
                                                    <TableCell>{index + 1}</TableCell>
                                                    <TableCell>
                                                        {(question.question || question.text) && (question.question || question.text).length > 100
                                                            ? `${(question.question || question.text).substring(0, 100)}...`
                                                            : (question.question || question.text)}
                                                    </TableCell>
                                                    <TableCell>
                                                        <Chip
                                                            label={question.responseType || (question.responseTypeId === 1 ? 'TEXT' : question.responseTypeId === 2 ? 'QCM' : 'SCORE')}
                                                            color={
                                                                (question.responseType === 'QCM' || question.responseTypeId === 2) ? 'primary' :
                                                                (question.responseType === 'SCORE' || question.responseTypeId === 3) ? 'error' : 'secondary'
                                                            }
                                                            size="small"
                                                        />
                                                    </TableCell>
                                                    <TableCell>
                                                        <Grid container spacing={2} alignItems="center">
                                                            <Grid item xs={8}>
                                                                <Slider
                                                                    value={timeConfigs[question.questionId || question.questiondId] || 15}
                                                                    min={1}
                                                                    max={60}
                                                                    step={1}
                                                                    marks={[
                                                                    ...
                                                                    onChange={(e, newValue) => handleTimeChange(question.questionId || question.questiondId, newValue)}
                                                                />
                                                            </Grid>
                                                            <Grid item xs={4}>
                                                                <TextField
                                                                    ...
                                                                    onChange={(e) => {
                                                                        ...
                                                                        handleTimeChange(question.questionId || question.questiondId, value);
                                                                    }}
                                                                    fullWidth
                                                                    size="small"
                                                                />
