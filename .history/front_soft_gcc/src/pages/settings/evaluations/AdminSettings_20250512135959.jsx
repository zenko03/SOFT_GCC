...
import { FaClock, FaSave, FaEdit, FaArrowLeft, FaCheck, FaTimes } from 'react-icons/fa';
...
const AdminSettings = () => {
  ...
  const saveTimeConfigurations = async () => {
    ...
    try {
      ...
      await axios.post(`https://localhost:7082/api/evaluation/questions/update-time`, 
        questionsWithTime, 
        { headers: { Authorization: `Bearer ${token}` } }
      );
