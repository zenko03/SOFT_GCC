            ...
            <div className="content-wrapper">
                ...
                <div className="row">
                    <div className="col-md-4 grid-margin stretch-card">
                        <div className="card card-stat" onClick={handleQuestionsClick}>
                            <div className="card-body">
                                <div className="d-flex align-items-center justify-content-center flex-column">
                                    <i className="mdi mdi-clipboard-text-outline icon-lg text-primary mb-2"></i>
                                    <h5 className="mb-0">Questionnaires d&apos;évaluation</h5>
                                    <p className="text-muted mt-3 mb-0">Gérer les questions et types d&apos;évaluation</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 grid-margin stretch-card">
                        <div className="card card-stat" onClick={handleFormationClick}>
                            <div className="card-body">
                                <div className="d-flex align-items-center justify-content-center flex-column">
                                    <i className="mdi mdi-school-outline icon-lg text-warning mb-2"></i>
                                    <h5 className="mb-0">Suggestions de Formations</h5>
                                    <p className="text-muted mt-3 mb-0">Configurer les formations recommandées</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {canAccessAdmin && (
                        <div className="col-md-4 grid-margin stretch-card">
                            <div className="card card-stat" onClick={handleAdminClick}>
                                <div className="card-body">
                                    <div className="d-flex align-items-center justify-content-center flex-column">
                                        <i className="mdi mdi-tune icon-lg text-danger mb-2"></i>
                                        <h5 className="mb-0">Administration</h5>
                                        <p className="text-muted mt-3 mb-0">Configuration des paramètres avancés</p>
                                    </div>
                                </div>
                            </div>
                        </div>
