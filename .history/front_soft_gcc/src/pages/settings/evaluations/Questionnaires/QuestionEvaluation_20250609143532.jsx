...
function QuestionEvaluation() {
    ...
    }, [pageNumber, pageSize, allQuestions, filterEvaluationType, filterPosition, searchQuery]);
    ...
    const getFilteredQuestions = () => {
        ...
        return allQuestions.filter(question => {
            ...
            return matchesEvaluationType && matchesPosition && matchesSearch;
        });
    };
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="d-flex justify-content-center align-items-center mt-4">
                                            <div className="pagination-controls d-flex align-items-center">
                                                ...
                                                <div className="input-group input-group-sm ms-2" style={{ width: '150px' }}>
                                                    <span className="input-group-text">Aller à</span>
                                                    <input
                                                        type="number"
                                                        min="1"
                                                        max={totalPages}
                                ...
                                <div className="modal-dialog modal-lg modal-dialog-centered">
                                    <div className="modal-content">
                                        ...
                                        <div className="modal-footer">
                                            <button type="button" className="btn btn-outline-danger btn-fw" onClick={() => setShowAddModal(false)}>
                            ...
                            >
                                <div className="modal-dialog modal-lg modal-dialog-centered">
                                    <div className="modal-content">
                                        ...
                                        <div className="modal-footer">
                                            <button type="button" className="btn btn-outline-danger btn-fw" onClick={() => setShowEditModal(false)}>
                                                <i className="mdi mdi-close-circle"></i> Annuler
                                            </button>
