                                            ...
                                            <div className="table-responsive">
                                                <table className="table table-hover">
                                                    <thead className="bg-light">
                                                        <tr>
                                                            <th scope="col" style={{ width: '60px', padding: '8px 15px' }}>
                                                    ...
                                                    <tbody>
                                                        {questions.map((question, index) => {
                                                            ...
                                                            return (
                                                                <tr key={questionId} className={selectedItems.includes(questionId) ? 'table-active' : ''}>
                                                                    <td style={{ padding: '8px 15px' }} onClick={(e) => {
                                                                        // Empêcher la propagation si on clique directement sur la cellule
                                                                        e.stopPropagation();
                                                                    }}>
                                                                        <div className="form-check position-relative" style={{ marginLeft: '5px' }}>
                                                                            <input
                                                                                className="form-check-input"
                                                                                type="checkbox"
