...
import { 
    ...
    faSave, faTimes, faQuestionCircle
...
function QuestionEvaluation() {
    ...
    const fetchCompetenceLines = async () => {
        try {
            ...
            } catch (/* eslint-disable-next-line no-unused-vars */ _) {
                            ...
                            <div className="col-md-12">
                                <div className="card mb-4">
                                    <div className="card-header bg-primary text-white">
                                        <h5 className="m-0">
                                            <FontAwesomeIcon icon={currentQuestion ? faEdit : faPlus} className="me-2" />
                                            {currentQuestion ? 'Modifier la question' : 'Ajouter une nouvelle question'}
                                        </h5>
                                    </div>
                                        ...
                                        <form onSubmit={handleSubmit}>
                                            <div className="row mb-3">
                                                <div className="col-md-12">
                                                    <label htmlFor="question" className="form-label">
                                                        <FontAwesomeIcon icon={faQuestionCircle} className="me-1" /> Question
                                                    </label>
                                                    <input
                                                        type="text"
                                                        name="question"
                                            ...
                                            <div className="text-end mb-3">
                                                <button type="submit" className="btn btn-primary me-2">
                                                    ...
                                                    {currentQuestion ? 'Mettre à jour' : 'Ajouter'}
                                                </button>
                                                {currentQuestion && (
                                                    <button
                                                        type="button"
                                                ...
                                                >
                                                    <FontAwesomeIcon icon={faSync} /> Réinitialiser
                                                </button>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <div className="row">
                            <div className="col-md-12">
                                <div className="card">
                                    <div className="card-header bg-light">
                                        <div className="d-flex justify-content-between align-items-center">
                                            <h5 className="m-0">Liste des Questions ({filteredQuestions.length})</h5>
                                        </div>
                                    </div>
                                    <div className="card-body">
                                                ...
                                                <table className="table table-hover table-striped">
                                                    ...
                                                    <tbody>
                                                        {filteredQuestions.map((question, index) => {
                                                            ...
                                                            const positionName = positions.find(position => position.positionId === question.positionId)?.positionName || "N/A";
                                                            
                                                            // Recherche de la compétence
                                                            const competence = question.competenceLineId ? 
                                                            ...
                                                            const competenceName = competence 
                                                                ? (competence.Description || competence.description || competence.competenceName)
                                                                : "-";
                                                            ...
                                                            return (
                                                                <tr key={questionId}>
                                                                    ...
                                                                    <td>{evalType}</td>
                                                                    <td>{positionName}</td>
                                                                    <td><span className="badge bg-info text-dark">{responseTypeName}</span></td>
