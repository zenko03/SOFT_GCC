...
function QuestionEvaluation() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Format exact correspondant à EvaluationQuestion.cs dans l'API backend
            // Utiliser le format avec CompetenceLineId et ResponseTypeId en PascalCase
            // car c'est ce que le modèle backend attend
            const requestData = currentQuestion
                ? {
                    ...
                    CompetenceLineId: competenceLineId,  // PascalCase dans l'entité backend
                    ResponseTypeId: responseTypeId,      // PascalCase dans l'entité backend
            ...
            console.log('Envoi des données au format attendu par l\'API backend:', requestData);
