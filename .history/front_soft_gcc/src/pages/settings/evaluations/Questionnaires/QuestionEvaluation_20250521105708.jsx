...
function QuestionEvaluation() {
        ...
        try {
            ...
            const requestData = currentQuestion
                ? {
                    ...
                    position: {
                        positionId: positionId,
                        positionName: positions.find(p => p.positionId === positionId)?.positionName || ''
                    }
                }
                : {
    ...
    const handleEdit = (question) => {
        ...
        setFormData({ question: question.question, evaluationTypeId: question.evaluationTypeId, positionId: question.positionId });
    };
    ...
    const handlePreviousPage = () => {
        ...
        const filteredQuestions = (questions || []).filter(question => {        const matchesEvaluationType = filterEvaluationType ? question.evaluationTypeId === Number(filterEvaluationType) : true;        const matchesPosition = filterPosition ? question.positionId === Number(filterPosition) : true;        return matchesEvaluationType && matchesPosition;    });
