...
function PermissionsManagement() {
    ...
    const handlePermissionToggle = async (permissionId) => {
        ...
        try {
            ...
            console.log('Données envoyées (format simplifié):', JSON.stringify(data));

            // Appel avec XMLHttpRequest natif pour déboguer
            const xhr = new XMLHttpRequest();
            xhr.open('PUT', `https://localhost:7082/api/Permission/role/${selectedRole.roleId}`, true);
            ...
            xhr.onerror = function() {
                ...
                toast.error('Erreur réseau lors de la mise à jour des permissions');
            };
