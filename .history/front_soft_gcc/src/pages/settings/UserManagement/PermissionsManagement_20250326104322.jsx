    ...
    return (
        <Template>
            <div className="container-fluid">
                ...
                {searchQuery.trim() && filteredPermissionsList.length === 0 && !loading && (
                    ...
                    <table className="table table-hover">
                        ...
                        <tbody>
                            {loading ? (
                                ...
                                filteredPermissionsList.map((permissionItem) => (
                                    <tr key={permissionItem.permissionId}>
                                            ...
                                            <td className="text-center">
                                                <div className="form-check d-flex justify-content-center">
                                                    <input
                                                        ...
                                                        checked={isEditing 
                                                            ? tempPermissions.some(p => p.permissionId === permissionItem.permissionId)
                                                            : rolePermissions.some(p => p.permissionId === permissionItem.permissionId)
                                                        }
                                                        onChange={() => handlePermissionToggle(permissionItem.permissionId)}
                                                        disabled={!isEditing && !rolePermissions.some(p => p.permissionId === permissionItem.permissionId)}
                                                    />
                                                </div>
                                            </td>
                                        )}
                                        <td className="text-center">
                                            <button
                                                ...
                                                onClick={() => handleEdit(permissionItem)}
                                                title="Modifier"
                                            >
                                                <FaEdit />
                                            </button>
                                            <button
                                                ...
                                                onClick={() => handleDelete(permissionItem.permissionId)}
                                                title="Supprimer"
                                            >
                                                <FaTrash />
                                            </button>
