...
function PermissionsManagement() {
    ...
    const handlePermissionToggle = async (permissionId) => {
        ...
        try {
            // Créer la nouvelle liste des IDs de permissions
            ...
            console.log('Envoi des permissions:', newPermissionIds);
            ...
            // Recharger les permissions du rôle plutôt que de mettre à jour l'état local
            // pour s'assurer que l'état correspond exactement à ce qui est en base de données
    ...
    const filteredPermissions = permissions.filter(permission => {
        // Si la permission est null ou undefined, ou si son nom n'existe pas, l'exclure
        if (!permission || !permission.name) return false;
        
        // Si aucune recherche n'est effectuée, inclure la permission
        ...
        // Vérifier si la description contient la recherche, seulement si la description existe
        const descriptionMatch = permission.description ? 
            permission.description.toLowerCase().includes(searchLower) : false;
        
        // Inclure la permission si son nom ou sa description correspond à la recherche
