...
function UsersList() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (currentUser) {
                ...
                await axios.post('https://localhost:7082/api/Authentification/register', formData);
            }
            setShowModal(false);
            fetchUsers();
            resetForm();
            ...
            if (error.response) {
                ...
                alert(`Erreur: ${error.response.data.message || 'Une erreur est survenue lors de la mise à jour'}`);
            }
        }
    };
    ...
    const handleEdit = (user) => {
        ...
        setFormData({
            ...
            email: user.email || "",
            roleId: user.roleId || (user.role ? user.role.roleId : ""),
