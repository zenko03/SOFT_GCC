...
function PermissionsManagement() {
    ...
    const [hasFilterResults, setHasFilterResults] = useState(true);
    ...
    useEffect(() => {
        if (permissions.length > 0) {
            const results = filterPermissions(permissions, searchQuery);
            setHasFilterResults(results.length > 0);
        }
    ...
    const filterPermissions = (permissionsList, query) => {
        if (!query.trim()) return permissionsList;
        ...
        return permissionsList.filter(permission => {
            ...
            // Chercher tous les termes indépendamment
                                ...
                                <tr>
                                    <td colSpan="4" className="text-center py-4">
                                        {searchQuery ? (
                                            ...
                                            <div>Aucune permission trouvée</div>
                                        )}
                                    </td>
                                </tr>
                            ) : (
