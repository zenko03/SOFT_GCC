...
function UsersList() {
    ...
    const fetchUsers = async () => {
        try {
            setLoading(true);
            const response = await axios.get('https://localhost:7082/api/User/users', {
                params: {
    ...
    const fetchDepartments = async () => {
        try {
            const response = await axios.get('https://localhost:7082/api/Department');
    ...
    const fetchPostes = async () => {
        try {
            const response = await axios.get('https://localhost:7082/api/Poste');
