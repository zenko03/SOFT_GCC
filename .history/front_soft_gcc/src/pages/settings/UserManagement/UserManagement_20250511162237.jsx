...
function UserManagement() {
    ...
    console.log('Permissions actuelles:', hasPermission('MANAGE_USERS'));

    const handleUsersClick = () => {
        console.log('Clic sur Gestion des Utilisateurs');
        if (hasPermission('MANAGE_USERS')) {
            navigate("/users-list");
        } else {
            console.log('Permission MANAGE_USERS non accordée');
