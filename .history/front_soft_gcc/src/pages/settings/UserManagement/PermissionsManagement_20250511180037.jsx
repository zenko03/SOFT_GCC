...
import { FaPlus, FaSave, FaTimes, FaChevronDown, FaChevronRight, FaSearch, FaShield, FaUserLock } from 'react-icons/fa';
                        ...
                        <div className="card shadow-sm border-0 mb-4">
                            <div className="card-header bg-white py-3">
                                <h6 className="m-0 fw-bold text-primary d-flex align-items-center">
                                    <FaShield className="me-2" /> Sélectionner un rôle
                                </h6>
                            </div>
