...
const ProtectedRoute = ({ requiredPermission }) => {
  ...
  useEffect(() => {
    if (userPermissions && userPermissions.length > 0) {
      console.log('Permissions détaillées:', JSON.stringify(userPermissions, null, 2));
      const hasRequiredPermission = hasPermission(requiredPermission);
      console.log('Vérification de la permission:', requiredPermission, 'Résultat:', hasRequiredPermission);
