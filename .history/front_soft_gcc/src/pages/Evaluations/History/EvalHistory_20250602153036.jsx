...
import { FaFileExcel, FaFilePdf, FaFileCsv, FaChartLine, FaSync, FaSearch, FaDownload, FaCalendarAlt } from 'react-icons/fa';
                        ...
                        <div className="row g-2">
                          <div className="col-6">
                            <div className="stats-card p-2 rounded bg-light">
                              ...
                              <div className="h5 mb-0">
                                {detailedStats.scoreDistribution && detailedStats.scoreDistribution.average !== undefined
                          ...
                          <div className="col-6">
                            <div className="stats-card p-2 rounded bg-light">
                              ...
                              <div className="h5 mb-0" style={{ 
                                ...
                                {detailedStats.trendData && detailedStats.trendData.percentageChange > 0 ? '+' : ''}
                                {detailedStats.trendData && detailedStats.trendData.percentageChange !== undefined 
                          ...
                          <div className="col-6">
                            <div className="stats-card p-2 rounded bg-light">
                              ...
                              <div className="h5 mb-0">
                                {detailedStats.scoreDistribution && detailedStats.scoreDistribution.min !== undefined
                          ...
                          <div className="col-6">
                            <div className="stats-card p-2 rounded bg-light">
                              ...
                              <div className="h5 mb-0">
                                {detailedStats.scoreDistribution && detailedStats.scoreDistribution.max !== undefined
                        ...
                        <div className="mt-4">
                          ...
                          <div className="progress" style={{ height: "24px" }}>
                            <div 
                              ...
                              role="progressbar" 
                              style={{ 
                                width: `${detailedStats.scoreDistribution.low / (detailedStats.scoreDistribution.low + detailedStats.scoreDistribution.medium + detailedStats.scoreDistribution.high) * 100}%`,
                                transition: 'width 0.5s ease-in-out'
                              }}
                              aria-valuenow={detailedStats.scoreDistribution.low} 
                              aria-valuemin="0" 
                              aria-valuemax="100"
                              title={`Faible: ${detailedStats.scoreDistribution.low} évaluations`}
                            >
                              {detailedStats.scoreDistribution.low > 0 && (
                            ...
                            <div 
                              ...
                              role="progressbar" 
                              style={{ 
                                width: `${detailedStats.scoreDistribution.medium / (detailedStats.scoreDistribution.low + detailedStats.scoreDistribution.medium + detailedStats.scoreDistribution.high) * 100}%`,
                                transition: 'width 0.5s ease-in-out'
                              }}
                              aria-valuenow={detailedStats.scoreDistribution.medium} 
                              aria-valuemin="0" 
                              aria-valuemax="100"
                              title={`Moyen: ${detailedStats.scoreDistribution.medium} évaluations`}
                            >
                              {detailedStats.scoreDistribution.medium > 0 && (
                            ...
                            <div 
                              ...
                              role="progressbar" 
                              style={{ 
                                width: `${detailedStats.scoreDistribution.high / (detailedStats.scoreDistribution.low + detailedStats.scoreDistribution.medium + detailedStats.scoreDistribution.high) * 100}%`,
                                transition: 'width 0.5s ease-in-out'
                              }}
                              aria-valuenow={detailedStats.scoreDistribution.high} 
                              aria-valuemin="0" 
                              aria-valuemax="100"
                              title={`Élevé: ${detailedStats.scoreDistribution.high} évaluations`}
                            >
