    ...
    try {
      ...
      if (response.data && Array.isArray(response.data)) {
        ...
        const formattedData = response.data.map(item => ({
          ...
          averageScore: item.averageScore ? Number(item.averageScore.toFixed(2)) : 0,
              ...
              <div className="card border-0 bg-light">
                <div className="card-body">
                  ...
                  <h5 className="card-title">
                    {chartData.reduce((sum, item) => sum + item.averageScore, 0) / chartData.length || 0}
                    /5
                  </h5>
                </div>
              </div>
            ...
            <div className="col-md-3">
              <div className="card border-0 bg-light">
                <div className="card-body">
                  ...
                  <h5 className="card-title">
                    {chartData.length > 0 ? chartData.reduce((best, item) => 
                      item.averageScore > best.averageScore ? item : best, chartData[0]).year : 'N/A'}
                  </h5>
                </div>
              </div>
            </div>
              ...
              <div className="card border-0 bg-light">
                <div className="card-body">
                  ...
                  <h5 className="card-title" style={{ 
                    color: chartData.length > 1 && chartData[chartData.length-1].averageScore > chartData[0].averageScore ? '#4caf50' : '#e74c3c'
                  }}>
                    {chartData.length > 1 ? (chartData[chartData.length-1].averageScore > chartData[0].averageScore ? '↑ En hausse' : '↓ En baisse') : 'N/A'}
                  </h5>
                </div>
              </div>
            </div>
