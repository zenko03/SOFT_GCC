                        ...
                        <div className="row g-2">
                          <div className="col-6">
                            <div className="stats-card p-2 rounded bg-light">
                              ...
                              <div className="h5 mb-0">{detailedStats.scoreDistribution.average.toFixed(2)}</div>
                            </div>
                          </div>
                          <div className="col-6">
                            <div className="stats-card p-2 rounded bg-light">
                              ...
                              <div className="h5 mb-0" style={{ 
                                ...
                                {detailedStats.trendData.percentageChange > 0 ? '+' : ''}
                          ...
                          <div className="col-6">
                            <div className="stats-card p-2 rounded bg-light">
                              ...
                              <div className="h5 mb-0">{detailedStats.scoreDistribution.min.toFixed(1)}</div>
                            </div>
                          </div>
                          <div className="col-6">
                            <div className="stats-card p-2 rounded bg-light">
                              <div className="small text-muted">Score maximum</div>
                              <div className="h5 mb-0">{detailedStats.scoreDistribution.max.toFixed(1)}</div>
                            </div>
                          </div>
                        </div>
