...
const EvaluationDetailsModal = ({ evaluation, onClose }) => {
  ...
  // Préparer les données du graphique en barres avec une couleur uniforme plus professionnelle
  ...
  // Thème commun pour les graphiques - plus sobre et professionnel
  const chartTheme = {
    ...
    grid: { line: { stroke: "#eeeeee", strokeWidth: 1 } }
  };
                  ...
                  <div className="col-md-6">
                    ...
                    <p className="mb-3">
                      <span className={`badge ${
                        evaluation.interviewStatus === 10 ? "bg-secondary" :
                        evaluation.interviewStatus === 20 ? "bg-secondary" :
                        evaluation.interviewStatus === 25 ? "bg-secondary" :
                        evaluation.interviewStatus === 30 ? "bg-secondary" :
                        evaluation.interviewStatus === 40 ? "bg-secondary" :
                        "bg-secondary"
                      }`}>
                      ...
                      <div className="card-body">
                        <div style={{ height: 300 }}>
                          <ResponsiveBar
                            ...
                            colors={["#607D8B"]} // Couleur plus neutre et professionnelle
                            theme={chartTheme}
                      ...
                      <div className="card-body">
                        <div style={{ height: 300 }}>
                          <ResponsiveRadar
                            ...
                            dotBorderWidth={2}
                            colors={['#607D8B', '#E0E0E0']} // Couleurs plus neutres et professionnelles
                            blendMode="normal"
                            theme={chartTheme}
                          />
                        </div>
