...
import { FaChartBar, FaFilter, FaSync, FaUndo, FaChartLine, FaTachometerAlt } from 'react-icons/fa';
...
const GlobalPerformanceGraph = ({ filters = {} }) => {
    ...
    try {
      ...
      if (response.data) {
        setKpis({
          ...
          overallAverage: response.data.overallAverage || 0
        });
      }
    } catch (err) {
  ...
  useEffect(() => {
    ...
    fetchKPIs();
  }, [fetchDepartments, fetchEvaluationTypes, fetchGlobalPerformanceData, fetchKPIs]);
  ...
  return (
    <div className="global-performance-graph">
      ...
      {/* Statistiques de performance - Placées maintenant sous le graphique */}
      {chartData.length > 0 && (
        <div className="performance-stats mt-4">
          ...
          <div className="stats-cards">
            <div className="stats-vertical-layout">
