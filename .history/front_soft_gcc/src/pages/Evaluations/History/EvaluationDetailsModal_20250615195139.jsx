...
const EvaluationDetailsModal = ({ evaluation, onClose, onCancelEvaluation }) => {
  ...
  return (
    ...
    >
      ...
      <Modal.Footer style={{borderTop: `1px solid ${BORDER_COLOR}`, padding: '0.75rem 1.25rem', backgroundColor: 'white'}}>
        ...
        <Button variant="outline-danger" className="professional-button rounded-pill px-4 ms-2" style={{borderColor: MUSTARD_YELLOW, color: MUSTARD_YELLOW}} onClick={onCancelEvaluation}>
          Annuler
        </Button>
      </Modal.Footer>
    </Modal>
...
EvaluationDetailsModal.propTypes = {
  ...
  onCancelEvaluation: PropTypes.func.isRequired
};
