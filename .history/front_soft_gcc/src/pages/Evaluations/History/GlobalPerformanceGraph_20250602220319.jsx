...
import { FaChartBar, FaChartLine, FaTachometerAlt, FaClipboardList } from 'react-icons/fa';
      ...
      <div className="kpi-section mb-4">
        ...
        <div className="kpi-cards">
          <div className="row g-3">
            ...
            <div className="col-md-3">
              <div className="kpi-card total-evaluations">
                <div className="kpi-icon">
                  <FaClipboardList />
                </div>
                <div className="kpi-content">
                  <h3>{kpis.totalEvaluations > 0 ? kpis.totalEvaluations : '--'}</h3>
                  <p>Total des Évaluations</p>
                </div>
              </div>
            </div>
          </div>
