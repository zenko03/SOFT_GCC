    ...
    if (!startDate || !endDate) {
      ...
      if (startDate < today) {
        ...
        if (durationInDays < recommendation.days) {
          error = `La durée planifiée (${durationInDays} jours) est inférieure à la durée recommandée (${recommendation.days} jours) pour ce type d'évaluation avec ${selectedEmployees.length} employé(s). Veuillez augmenter la durée ou réduire le nombre d'employés.`;
        }
      }
    }
