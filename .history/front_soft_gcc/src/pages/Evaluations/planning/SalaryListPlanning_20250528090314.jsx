          ...
          <>
            ...
            <div className="filters card p-3 mb-4">
              <div className="d-flex align-items-center justify-content-between">
                {/* Groupe pour les champs de recherche et de filtre */}
                <div className="d-flex align-items-center flex-grow-1 gap-3 me-3">
                  <input
                    type="text"
                ...
                <button
                  ...
                  style={{ flexShrink: 0 }} // Empêche le bouton de se réduire
                >
