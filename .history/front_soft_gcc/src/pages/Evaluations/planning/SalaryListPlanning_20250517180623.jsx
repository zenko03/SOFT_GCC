  ...
  const handleMassPlanning = async () => {
    ...
    try {
      ...
      const payload = selectedEmployees.map((employeeId) => {
        // Récupérer l'employé pour connaître son lien avec User si nécessaire
        const employee = employees.find(e => e.employeeId === employeeId);
        
        return {
          userId: employee.userId || employeeId, // Utilisez userId s'il existe, sinon utilisez employeeId comme fallback temporaire
          employeeId: employeeId, // Ajout de l'employeeId
