                    ...
                    <div key={competence.competenceLineId} className="competence-section">
                      ...
                      <div className="questions-list">
                        {questions[employeeId]?.[competence.competenceLineId]?.map(question => (
                          <div key={`${employeeId}-${competence.competenceLineId}-${question.questionId}`} className="question-item">
                            <div className="form-check">
                              <input
                                type="checkbox"
                                className="form-check-input"
                                id={`question-${employeeId}-${competence.competenceLineId}-${question.questionId}`}
                              ...
                              />
                              <label className="form-check-label" htmlFor={`question-${employeeId}-${competence.competenceLineId}-${question.questionId}`}>
                                {question.question}
                              </label>
                            </div>
                          </div>
