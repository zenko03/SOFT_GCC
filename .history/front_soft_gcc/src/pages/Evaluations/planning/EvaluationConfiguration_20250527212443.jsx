  ...
  const validateDates = (startDateStr, endDateStr) => {
    ...
    if (!startDate || !endDate) {
        ...
        if (startDate < today) {
            ...
            // Validation de la durée minimale selon le type d'évaluation
                ...
                switch (evaluationType.designation.toLowerCase()) {
                    case 'évaluation annuelle':
                        if (durationInDays < 14) {
                            error = 'L\'évaluation annuelle doit durer au moins 2 semaines.';
                        }
                        break;
                    case 'évaluation de performance':
                    case 'évaluation de compétences':
                        if (durationInDays < 7) {
                            error = 'L\'évaluation de performance/compétences doit durer au moins 1 semaine.';
                        }
                        break;
                    case 'évaluation de progression':
                        if (durationInDays < 5) {
                            error = 'L\'évaluation de progression doit durer au moins 5 jours.';
                        }
                        break;
                    default:
                        if (durationInDays < 3) {
                            error = 'L\'évaluation doit durer au moins 3 jours.';
                        }
                }
            }
        }
    ...
    <div className="step-content">
      ...
      <div className="form-group">
        ...
        <div className="mt-2 text-muted small">
          ...
          <ul className="mb-0">
            <li>Évaluation annuelle : 2-3 semaines</li>
            <li>Évaluation de performance : 1-2 semaines</li>
            <li>Évaluation de compétences : 1-2 semaines</li>
            <li>Évaluation de progression : 5-7 jours</li>
          </ul>
        </div>
      </div>
    </div>
