      ...
      <div className="form-group">
        ...
        {selectedEvaluationType && selectedEmployees.length > 0 && (
          <div className="alert alert-info mt-2">
            ...
            <strong>Recommandation actuelle:</strong> {durationRecommendation?.days} jours ({durationRecommendation?.weeks} semaines) pour évaluer {selectedEmployees.length} employé{selectedEmployees.length > 1 ? 's' : ''} avec {selectedSupervisors.length || 1} superviseur{(selectedSupervisors.length > 1 || selectedSupervisors.length === 0) ? 's' : ''}.
