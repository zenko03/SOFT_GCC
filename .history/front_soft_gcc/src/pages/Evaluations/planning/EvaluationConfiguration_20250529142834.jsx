                ...
                <div key={`employee-${employeeId}`} className="employee-questions">
                  ...
                  <div className="accordion" id={`accordion-employee-${employeeId}`}>
                    {sortedCompetences.map((competence, index) => {
                      ...
                      const sortedQuestions = competenceQuestions && Array.isArray(competenceQuestions) 
                        ? competenceQuestions.sort((a, b) => (a.question || '').localeCompare(b.question || ''))
                        : [];
                      ...
                      return (
                        <div key={`competence-${employeeId}-${competence.competenceLineId}`} className="card">
                          <div className="card-header" id={headingId}>
                            <h2 className="mb-0">
                              ...
                              >
                                <i className="fas fa-chevron-right mr-2" style={{ transition: 'transform 0.2s' }}></i>
