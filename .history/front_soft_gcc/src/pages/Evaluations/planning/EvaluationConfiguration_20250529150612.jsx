                      ...
                      <div key={`competence-${employeeId}-${competence.competenceLineId}`} className="competence-section mb-4">
                        <h5 className="competence-title bg-light p-3 rounded d-flex justify-content-between align-items-center">
                          <span>
                            ...
                            {competence.description || competence.skillName || 
                             (competence.SkillPosition && (competence.SkillPosition.Skill?.Name || competence.SkillPosition.description)) || 
                             `Compétence #${competence.competenceLineId}`}
                          </span>
                        ...
                        <div className="questions-list p-3">
                          {filteredQuestions.length > 0 ? (
                            ...
                            <div className="no-questions alert alert-light">
