              ...
              return (
                <div key={`employee-${employeeId}`} className="employee-questions">
                  ...
                  {competenceLines[employeeId]?.map(competence => {
                    // Filtrer les questions pour cette compétence spécifique
                    const competenceQuestions = questions[employeeId]?.[competence.competenceLineId]?.filter(
                      q => q.competenceLineId === competence.competenceLineId
                    );
                    
                    console.log('Questions filtrées pour la compétence:', {
                      employeeId,
                      competenceLineId: competence.competenceLineId,
