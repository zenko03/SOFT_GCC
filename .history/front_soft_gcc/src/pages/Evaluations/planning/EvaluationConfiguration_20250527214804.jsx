...
function EvaluationConfiguration({ selectedEmployees, employees, onBack, onComplete, onRemoveEmployee }) {
  ...
  const renderStep1Content = () => (
    <div className="step-content">
      ...
      {/* Durée et Dates */}
      <div className="form-group">
        <label>Durée et période d&apos;évaluation</label>
        ...
        <div className="mt-2 text-muted small">
          ...
          <ul className="mb-0">
            ...
            <li>Évaluation de performance : {selectedEmployees.length <= 1 ? '1 semaine' : '2-3 semaines'}</li>
            <li>Évaluation de compétences : {selectedEmployees.length <= 1 ? '1 semaine' : '2-3 semaines'}</li>
            <li>Évaluation de progression : {selectedEmployees.length <= 1 ? '3-5 jours' : '1-2 semaines'}</li>
          </ul>
        ...
        return (
          <div className="step-content">
            ...
            <div className="configuration-summary">
              ...
              <div className="summary-section">
                <h4>Durée et période d&apos;évaluation</h4>
                <p>
