                ...
                <div key={`employee-${employeeId}`} className="employee-questions">
                  ...
                  <div className="accordion" id={`accordion-employee-${employeeId}`}>
                    {sortedCompetences.map((competence) => {
                      ...
                      // Supprimer les doublons basés sur questionId
                      const uniqueQuestions = Array.from(new Map(competenceQuestions.map(q => [q.questionId, q])).values());
                      
                      // Trier les questions par ordre alphabétique
                      const sortedQuestions = uniqueQuestions.sort((a, b) => 
                        (a.question || '').localeCompare(b.question || '')
                      );

                      return (
                        <div key={`competence-${employeeId}-${competence.competenceLineId}`} className="competence-accordion-card">
                            ...
                            <h2 className="mb-0">
                              ...
                              >
                                <span className="competence-title">
                                  {competence.competenceName || 'Compétence sans nom'}
