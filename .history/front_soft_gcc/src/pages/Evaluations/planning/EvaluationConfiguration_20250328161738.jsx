                  ...
                  {competenceLines[employeeId]?.map(competence => (
                    <div key={competence.competenceLineId} className="competence-section">
                      ...
                      <div className="questions-list">
                        {questions[employeeId]?.[competence.competenceLineId]?.filter(question => question.questionId !== undefined).map(question => {
                          // Créer une clé unique mais sans conversion
                          const uniqueKey = `${employeeId}-${competence.competenceLineId}-${question.questionId}`;

                          // Vérifier si cette question est sélectionnée
