...
const ParticipantsSelector = ({
  ...
  useEffect(() => {
    ...
    if (simpleEmployee) {
      ...
      console.log("ParticipantSelector - ATTENTION: Aucun employé trouvé directement");
    }
  }, [simpleEmployee, selectedParticipants, setSelectedParticipants]);
