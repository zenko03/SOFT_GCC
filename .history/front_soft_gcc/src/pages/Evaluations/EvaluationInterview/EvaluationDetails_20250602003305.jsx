        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    if (payload.hasOwnProperty('manager_approval')) {
                        completePayload.managerApproval = payload.manager_approval;
                    }
                    if (payload.hasOwnProperty('manager_comments')) {
                        completePayload.managerComments = payload.manager_comments;
                    }
                    if (payload.hasOwnProperty('director_approval')) {
                        completePayload.directorApproval = payload.director_approval;
                    }
                    if (payload.hasOwnProperty('director_comments')) {
