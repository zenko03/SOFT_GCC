...
const ParticipantsSelector = ({
  ...
  useEffect(() => {
    ...
    if (fetchedEmployee) {
      console.log("ParticipantSelector - employé trouvé:", fetchedEmployee);
      ...
      console.log("ParticipantSelector - ID employé:", employeeId);
      console.log("ParticipantSelector - Participants actuels:", selectedParticipants);
  ...
  const findParticipantById = (participantId) => {
    return participantsList.find(p => Number(p.employeeId || p.id) === participantId);
  };
