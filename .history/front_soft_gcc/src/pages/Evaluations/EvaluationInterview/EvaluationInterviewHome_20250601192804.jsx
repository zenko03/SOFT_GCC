              ...
              <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable custom-modal">
                <div className="modal-content shadow">
                  ...
                  <div className="modal-body">
                    {/* Carte de l'employé avec design moderne */}
                    {window.selectedEmployeeForModal && (
                      <div className="card mb-4 border-0 shadow-sm">
                        <div className="card-body p-0">
                          <div className="employee-header bg-light p-3 d-flex align-items-center">
                            <div className="employee-avatar me-3 bg-primary text-white" style={{
                              width: '52px',
                              height: '52px',
                              borderRadius: '50%',
                              display: 'flex',
                            ...
                            <div>
                              <h5 className="mb-1 fw-bold">{window.selectedEmployeeForModal.firstName} {window.selectedEmployeeForModal.lastName}</h5>
                    ...
                    <form className="needs-validation">
                      ...
                      <div className="form-group mb-4">
                        ...
                        {dateError && (
                          <div className="alert alert-danger p-2 d-flex align-items-center">
                    ...
                    <div className="alert alert-info d-flex align-items-center">
                      <i className="mdi mdi-information me-3 fs-5"></i>
                      <small>
                        Les participants sélectionnés recevront une notification par email concernant l&apos;entretien planifié.
                      </small>
                    </div>
                  </div>
                  ...
                  <div className="modal-footer bg-light">
                    ...
                    <button className="btn btn-primary d-flex align-items-center" onClick={handleMassPlanning}>
