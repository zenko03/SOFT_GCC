...
function EvaluationInterviewHome() {
  ...
  const startInterview = useCallback(async (employeeId) => {
    try {
      ...
      // Étape 3: Actualiser la liste pour voir les changements de statut
      await fetchEmployeesWithoutEvaluations();
      console.log("Liste des employés actualisée après le démarrage de l'entretien");
      
      // Étape 4: Redirection vers la page de validation
