            ...
            <div className="modal fade show" tabIndex="-1" style={{ display: 'block' }}>
              <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable custom-modal">
                <div className="modal-content">
                  <div className="modal-header" style={{ backgroundColor: '#f0f5ff', borderBottom: '2px solid #dee2e6' }}>
                    <h5 className="modal-title">
                      <i className="mdi mdi-calendar-clock mr-2"></i> Planification d&apos;entretien
                    </h5>
                  ...
                  <div className="modal-body">
                    {/* Carte de l'employé sélectionné */}
                    {window.selectedEmployeeForModal && (
                      <div className="card mb-3">
                        <div className="card-header bg-info text-white">
                          <h6 className="mb-0">Employé concerné par l&apos;évaluation</h6>
                        </div>
                        <div className="card-body d-flex align-items-center">
                          <div className="employee-avatar mr-3" style={{
                            width: '48px',
                            height: '48px',
                            borderRadius: '50%',
                            ...
                            {window.selectedEmployeeForModal.firstName?.charAt(0) || ''}
                            {window.selectedEmployeeForModal.lastName?.charAt(0) || ''}
                          </div>
                          <div>
                            <h6 className="mb-1">{window.selectedEmployeeForModal.firstName} {window.selectedEmployeeForModal.lastName}</h6>
                    ...
                    <form>
                      ...
                      <div className="form-group">
                        <label htmlFor="scheduledDateTime" className="font-weight-bold">
                          <i className="mdi mdi-clock-outline mr-1"></i> Date et heure planifiée
                        </label>
                        ...
                        <small className="form-text text-muted">
                          Choisissez une date et une heure pour l&apos;entretien d&apos;évaluation
                        </small>
                      </div>
                      
                      {/* Sélection des participants */}
                      <div className="card mt-3">
                        <div className="card-header" style={{ backgroundColor: '#f0f5ff' }}>
                          <h6 className="mb-0">
                            <i className="mdi mdi-account-multiple mr-1"></i> Participants à l&apos;entretien
                          </h6>
                        </div>
                        <div className="card-body">
                      ...
                      <div className="alert alert-light border mt-3" style={{ backgroundColor: '#f9f9f9' }}>
                        <small>
                          <i className="mdi mdi-information-outline mr-2"></i>
                          Les participants sélectionnés recevront une notification par email pour cet entretien.
                        </small>
                      </div>
                    </form>
                  </div>
                  <div className="modal-footer" style={{ backgroundColor: '#f9f9f9' }}>
                    <button className="btn btn-primary" onClick={handleMassPlanning}>
                      <i className="mdi mdi-calendar-check mr-1"></i> Planifier
                    </button>
