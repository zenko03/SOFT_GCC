...
const EvaluationDetails = ({ interview, employeeId }) => {
    ...
    const handleValidationSubmit = async (e) => {
        ...
        try {
            ...
            console.log("Est Directeur:", isDirector);
            ...
            const payload = {
                ...
                ManagerApproval: isManager ? validationForm.approved : interviewDetails?.managerApproval,
                ManagerComments: isManager ? validationForm.comments : interviewDetails?.managerComments || '',
                DirectorApproval: isDirector ? validationForm.approved : interviewDetails?.directorApproval,
                DirectorComments: isDirector ? validationForm.comments : interviewDetails?.directorComments || '',
            ...
            if ((isManager && payload.ManagerApproval === true && interviewDetails?.directorApproval === true) || 
                (isDirector && payload.DirectorApproval === true && interviewDetails?.managerApproval === true)) {
