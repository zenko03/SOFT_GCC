              ...
              <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable custom-modal">
                <div className="modal-content">
                  <div className="modal-header">
                    ...
                    <button type="button" className="btn-close" onClick={handleCloseModal} aria-label="Fermer"></button>
                  </div>
                  
                  <div className="modal-body">
                    {/* Carte de l'employé sélectionné - Style Settings */}
                    {window.selectedEmployeeForModal && (
                      <div className="card settings-card mb-4 p-3">
                        <div className="d-flex align-items-center">
                          <i className="mdi mdi-account-circle settings-icon"></i>
                          <div>
                            <h5 className="settings-title mb-1">{window.selectedEmployeeForModal.firstName} {window.selectedEmployeeForModal.lastName}</h5>
                    ...
                    <form>
                      ...
                      <div className="form-group mb-4">
                        <label htmlFor="scheduledDateTime" className="form-label">
                          ...
                          <span className="settings-title">Date et heure de l&apos;entretien</span>
                        </label>
                      ...
                      <div className="card mb-4">
                        <div className="card-header d-flex align-items-center">
                          <i className="mdi mdi-account-group me-2 settings-icon" style={{ fontSize: '1.5rem' }}></i>
                          <span className="settings-title">Participants à l&apos;entretien</span>
                        </div>
                        <div className="card-body">
