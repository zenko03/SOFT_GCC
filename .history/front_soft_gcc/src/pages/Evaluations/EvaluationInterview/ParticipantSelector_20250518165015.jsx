...
const ParticipantsSelector = ({
  ...
  useEffect(() => {
    ...
    if (targetEmployee) {
      ...
      const employeeId = getValidId(targetEmployee);
  ...
  return (
    <div className="form-group">
      ...
      <div className="debug-info mb-2 small text-muted">
        <div>targetEmployee: {targetEmployee ? `${targetEmployee.firstName} ${targetEmployee.lastName} (ID: ${getValidId(targetEmployee)})` : 'Non défini'}</div>
