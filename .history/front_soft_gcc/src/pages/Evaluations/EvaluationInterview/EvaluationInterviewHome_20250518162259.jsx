...
function EvaluationInterviewHome() {
  ...
  const handleOpenModal = useCallback(async (employeeId) => {
    ...
    try {
      // D'abord récupérer les détails de l'employé
      console.log(`Récupération des détails de l'employé ID: ${employeeId}`);
      ...
      console.log("Données de l'employé récupérées:", fetchedEmployee);
      console.log("Propriétés disponibles:", Object.keys(fetchedEmployee || {}));
      
      // Normaliser les propriétés pour gérer les différences de casse
      const normalizedEmployee = {
        employeeId: fetchedEmployee.employeeId || fetchedEmployee.EmployeeId,
        firstName: fetchedEmployee.firstName || fetchedEmployee.FirstName,
        lastName: fetchedEmployee.lastName || fetchedEmployee.LastName,
        evaluationId: fetchedEmployee.evaluationId || fetchedEmployee.EvaluationId,
      ...
      console.log("Employé normalisé:", normalizedEmployee);
      ...
      // Définir evaluationDetails avec l'employé sélectionné et ouvrir le modal
      setEvaluationDetails({
        evaluationId: parseInt(employee.evaluationId) || '',
        scheduledDate: today,
        participants: allParticipants,
        selectedEmployee: normalizedEmployee, // Définir directement ici
      });
      
      console.log("Ouverture du modal avec l'employé:", normalizedEmployee);
