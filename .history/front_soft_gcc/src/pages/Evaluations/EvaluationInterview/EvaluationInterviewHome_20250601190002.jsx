              ...
              <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div className="modal-content">
                  <div className="modal-header bg-primary text-white">
                    <h5 className="modal-title">Planification de l&apos;entretien d&apos;évaluation</h5>
                    <button type="button" className="btn-close btn-close-white" onClick={handleCloseModal} aria-label="Fermer"></button>
                  </div>
                  <div className="modal-body">
                      ...
                      <div className="alert alert-info d-flex align-items-center">
                        <div className="employee-avatar me-3">
                          <span className="avatar-placeholder">
                            {window.selectedEmployeeForModal.firstName?.charAt(0) || ''}{window.selectedEmployeeForModal.lastName?.charAt(0) || ''}
                          </span>
                        </div>
                        <div>
                          <strong>{window.selectedEmployeeForModal.firstName} {window.selectedEmployeeForModal.lastName}</strong>
                    ...
                    <form>
                      ...
                      <div className="form-group mb-4">
                        <label htmlFor="scheduledDateTime" className="form-label fw-bold">Date et heure de l&apos;entretien</label>
                        {dateError && <div className="alert alert-danger py-2 mt-2">{dateError}</div>}
                        <input
                          type="datetime-local"
                        ...
                        />
                        <small className="form-text text-muted">Sélectionnez une date et une heure pour l&apos;entretien d&apos;évaluation</small>
                      </div>

                      {/* Sélection des participants */}
                      <div className="card mb-4">
                        <div className="card-header bg-light">
                          <h6 className="mb-0">Participants à l&apos;entretien</h6>
                        </div>
                        <div className="card-body">
                      ...
                      {/* Notes ou informations supplémentaires si nécessaire */}
                      <div className="alert alert-light border">
                        <small>
                          <i className="fas fa-info-circle me-2"></i>
                          L&apos;entretien sera planifié pour les participants sélectionnés. Une notification leur sera envoyée par email.
                        </small>
                      </div>
                    </form>
                  </div>
