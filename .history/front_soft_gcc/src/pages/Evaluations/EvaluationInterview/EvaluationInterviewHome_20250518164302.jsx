...
function EvaluationInterviewHome() {
  ...
  const handleOpenModal = useCallback(async (employeeId) => {
    ...
    try {
      // Normaliser l'employé pour éviter les problèmes de format
      ...
      // Stocker l'employé normalisé dans la variable globale
      ...
      // Définir evaluationDetails avec l'employé sélectionné
      setEvaluationDetails({
        evaluationId: parseInt(employee.evaluationId) || '',
        scheduledDate: today,
        participants: allParticipants,
        selectedEmployee: normalizedEmployee, // Utiliser l'employé normalisé
      });
