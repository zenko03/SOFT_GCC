...
const EvaluationDetails = ({ interview, employeeId }) => {
    ...
    const handleValidationSubmit = async (e) => {
        ...
        try {
            ...
            // Créer un payload de base pour la mise à jour
            const updatePayload = {
                notes: interviewDetails.notes || '',
                
                // Valeurs par défaut ou existantes
                manager_approval: interviewDetails.managerApproval,
                manager_comments: interviewDetails.managerComments || '',
                director_approval: interviewDetails.directorApproval,
                director_comments: interviewDetails.directorComments || ''
            };
            
            // Mettre à jour les valeurs selon le rôle
            if (isManager) {
                updatePayload.manager_approval = validationForm.approved;
                updatePayload.manager_comments = validationForm.comments;
            } else if (isDirector) {
                updatePayload.director_approval = validationForm.approved;
                updatePayload.director_comments = validationForm.comments;
            }
            
            // Déterminer si l'entretien est complété (les deux validations sont faites)
            const isCompleted = 
                (updatePayload.manager_approval !== null && updatePayload.director_approval !== null) &&
            ...
            // Appeler la fonction de mise à jour directe
