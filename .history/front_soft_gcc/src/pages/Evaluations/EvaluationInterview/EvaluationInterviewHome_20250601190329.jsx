                    ...
                    {window.selectedEmployeeForModal && (
                      <div className="card mb-3">
                        ...
                        <div className="card-body d-flex align-items-center">
                          <div className="employee-avatar me-3" style={{
                            width: '48px',
                            height: '48px',
                            borderRadius: '50%',
                    ...
                    <form>
                      ...
                      <div className="form-group">
                        <label htmlFor="scheduledDateTime" className="font-weight-bold">
                          <i className="mdi mdi-clock-outline me-1"></i> Date et heure planifiée
                        </label>
                      ...
                      <div className="card mt-3">
                        <div className="card-header" style={{ backgroundColor: '#f0f5ff' }}>
                          <h6 className="mb-0">
                            <i className="mdi mdi-account-multiple me-1"></i> Participants à l&apos;entretien
                          </h6>
                        </div>
                        <div className="card-body">
