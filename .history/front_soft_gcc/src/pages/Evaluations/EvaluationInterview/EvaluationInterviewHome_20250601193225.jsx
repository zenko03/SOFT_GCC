                  ...
                  <div className="modal-body">
                      ...
                      <div className="mb-4 p-3 border rounded bg-light">
                        <div className="row align-items-center">
                            <div className="col-md-2 text-center">
                                <i className="mdi mdi-account-circle" style={{ fontSize: '3rem', color: '#007bff' }}></i>
                            </div>
                    ...
                    <form>
                      ...
                      <div className="form-group mb-4">
                        <label htmlFor="scheduledDateTime" className="form-label fw-bold">
                          <i className="mdi mdi-calendar-range me-2"></i>Date et heure de l&apos;entretien
                        </label>
                      ...
                      <div className="form-group mb-0">
                        <label className="form-label fw-bold">
                            <i className="mdi mdi-account-multiple-plus me-2"></i>Participants à l&apos;entretien
                        </label>
