...
function EvaluationInterviewHome() {
  ...
  const handleOpenModal = useCallback(async (employeeId) => {
    ...
    try {
      ...
      console.log("Données complètes de l'employé récupérées:", fetchedEmployee);
      ...
      setEvaluationDetails({
        ...
        selectedEmployee: fetchedEmployee, // Définir directement ici
      });
      
      console.log("Ouverture du modal avec l'employé:", fetchedEmployee);
