...
const EvaluationInterviews = () => {
  ...
  // Mettre à jour la fonction handleSave pour utiliser l'endpoint correct
  const handleSave = async () => {
    try {
      ...
      // Former le payload correspondant à la structure CompleteInterviewDto attendue par le backend
      const payload = {
        notes: JSON.stringify(formData),
        // Conserver les valeurs existantes pour les approbations et commentaires
        ...
        // Maintenir le statut actuel (ou 20 = IN_PROGRESS si non défini)
        status: interview.status || 20
      };

      console.log("Payload final:", payload);
      
      // Utiliser l'endpoint correct qui accepte les notes selon le contrôleur
