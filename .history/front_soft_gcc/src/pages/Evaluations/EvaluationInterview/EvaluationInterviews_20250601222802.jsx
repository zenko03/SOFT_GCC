                  ...
                  <div className="card-body">
                    ...
                    {previewUrl ? (
                      <div className="pdf-preview">
                        ...
                        <div className="pdf-container" style={{ height: '500px', overflow: 'hidden', border: '1px solid #dee2e6', borderRadius: '4px' }}>
                          <iframe 
                            src={previewUrl} 
                            width="100%" 
                            height="100%" 
                      ...
                      <div className="text-center p-5 h-100 d-flex flex-column justify-content-center align-items-center border rounded" style={{ backgroundColor: '#f8f9fa', minHeight: '300px' }}>
