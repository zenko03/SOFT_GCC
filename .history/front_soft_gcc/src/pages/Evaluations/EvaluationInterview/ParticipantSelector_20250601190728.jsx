...
const ParticipantsSelector = ({
  ...
  // Debug avancé - vérifier tout ce qui pourrait influencer l'affichage de l'employé
  ...
  // Dump de toutes les propriétés de fetchedEmployee pour diagnostiquer le problème
  if (fetchedEmployee) {
    console.log("Propriétés de fetchedEmployee:");
    for (const [key, value] of Object.entries(fetchedEmployee)) {
      console.log(`  ${key}: ${value}`);
    }
  }
  
  // Dump de toutes les propriétés de window.selectedEmployeeForModal
  if (window.selectedEmployeeForModal) {
    console.log("Propriétés de window.selectedEmployeeForModal:");
    for (const [key, value] of Object.entries(window.selectedEmployeeForModal)) {
      console.log(`  ${key}: ${value}`);
    }
  }
  ...
  // Vérifier si nous avons bien un targetEmployee
  console.log("targetEmployee final:", targetEmployee);
  console.log("targetEmployeeId final:", targetEmployeeId);
