          ...
          <FormGroup>
            {options.map((option, index) => (
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    checked={answers[question.questionId]?.includes(option.optionId) || false}
                    onChange={() => handleAnswerChange(question.questionId, option.optionId, 'QCM')}
                  />
                }
      ...
      case 'TEXT':
        return (
          <TextField
            ...
            variant="outlined"
            placeholder="Veuillez saisir votre réponse ici..."
          />
        );
      default:
        return null;
