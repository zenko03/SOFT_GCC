    ...
    const fetchEvaluation = async () => {
      try {
        ...
        if (response.data && response.data.questions && response.data.questions.length > 0) {
          console.log('Initialisation des réponses pour', response.data.questions.length, 'questions');
          ...
          console.warn('Pas de questions disponibles dans les données d\'évaluation');
        }
