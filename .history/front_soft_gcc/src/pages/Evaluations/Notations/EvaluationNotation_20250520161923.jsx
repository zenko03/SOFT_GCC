...
const EvaluationNotation = () => {
  ...
  useEffect(() => {
    // Ne générer le PDF que si la validation est réussie et que la génération n'a pas encore été demandée
    if (validationSuccess && !isGeneratingPDF && !pdfGenerationRequested) {
  ...
  }, [validationSuccess, navigate, generatePDFFunc, isGeneratingPDF, pdfGenerationRequested]);
