...
const Step3 = ({ ratings, average, evaluationId, validationData, onValidationChange, onGeneratePDF }) => {
  ...
  useEffect(() => {
    ...
    console.log("Enregistrement de la fonction de génération PDF", evaluationId);
    
    // Créer une fonction wrapper très simple pour générer le PDF
    const simplePdfGenerationFunction = () => {
      console.log("Fonction de génération de PDF simple appelée");
    ...
    onGeneratePDF(simplePdfGenerationFunction);
