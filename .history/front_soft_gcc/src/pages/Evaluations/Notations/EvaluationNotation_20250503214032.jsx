    ...
    const fetchData = async () => {
      try {
        ...
        if (employeeId) {
          ...
          // Vérifier la structure du retour et extraire les informations
          // Utiliser les noms exacts des propriétés comme dans SalaryList
        ...
        // Sinon, essayer de récupérer l'évaluation directement
          ...
          if (evaluationResponse.data) {
            // Structure directe comme dans vemployee-details-paginated
            setSelectedEmployee({
            ...
            // Si l'API ne renvoie pas ces champs, essayer d'obtenir les données via l'userId
            if (!evaluationResponse.data.firstName || !evaluationResponse.data.position || !evaluationResponse.data.department) {
              ...
              if (employeeId) {
                try {
                  ...
                  // Mise à jour avec les bonnes propriétés
                  setSelectedEmployee({
                  ...
                  console.error('Erreur lors de la récupération des détails employé:', error);
                }
              }
            }
          }
