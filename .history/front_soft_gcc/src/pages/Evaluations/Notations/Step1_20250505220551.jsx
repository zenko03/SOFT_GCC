        ...
        formattedQuestions.forEach(question => {
          ...
          if (question.response) {
            ...
            if (question.responseType === 'QCM') {
              ...
              // Par défaut, une réponse correcte vaut 5/5, une réponse incorrecte 2/5
              const isCorrect = question.isCorrect;
              newRatings[question.questionId] = isCorrect ? 5 : 2;
              
              // Stocker également le texte de la réponse pour l'affichage
              newComments[question.questionId] = responseValue;
            } else {
              ...
              try {
                ...
                if (parsedValue && typeof parsedValue === 'object') {
                  ...
                  // Stocker également la réponse nettoyée
                  newComments[question.questionId] = cleanedResponse;
                }
              } catch {
                      ...
                      {question.responseType === 'QCM' ? (
                        <div className="qcm-response">
                          {(() => {
                            ...
                            return <span className="option-text">{question.response.responseValue.replace(/^"|"$/g, '')}</span>;
                          })()}
                        </div>
                      ) : (
