...
const Step3 = ({ ratings, average, evaluationId, validationData, onValidationChange, onGeneratePDF }) => {
  ...
  useEffect(() => {
    if (onGeneratePDF && employeeData) {
      ...
      // Passer la fonction au composant parent
      onGeneratePDF(generatePDF);
    }
  }, [onGeneratePDF, employeeData, evaluationId, ratings, average, validationData, trainingSuggestions]);
