...
// Ajout d'un verrouillage pour éviter les appels multiples
...
export const downloadEvaluationPDF = (
  ...
  // Empêcher les appels en boucle
  if (pdfGenerationLock) {
    console.warn("Génération de PDF déjà en cours, demande ignorée");
    return null;
  }
  ...
  try {
    ...
    const result = generateEvaluationPDF(
      evaluationData, 
      employeeData, 
      ratings, 
      average, 
