...
const EvaluationNotation = () => {
  ...
  const generatePDFAfterValidation = () => {
    ...
    if (pdfGenerationFunctionRef.current && typeof pdfGenerationFunctionRef.current === 'function') {
      try {
        ...
        // Récupérer et exécuter la fonction
        ...
        // Exécuter la fonction finale
        console.log("*** Type de la fonction finale:", typeof pdfFunction, "***");
  ...
  }, [validationSuccess, userRequestedPdf, navigate]);
