...
function SalaryList() {
  ...
  const handleOpenModal = async (employeeId) => {
    try {
      ...
      // Récupérer l'ID de l'évaluation depuis la liste des employés
      const employeeWithEval = employees.find(emp => emp.employeeId === employeeId);
      const evaluationId = employeeWithEval?.evaluationId;

      console.log('Types d\'évaluation reçus:', evalTypesResponse.data);
      console.log('Employé sélectionné:', employeeResponse.data);
