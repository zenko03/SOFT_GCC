...
function Step1({ evaluationId, setRatings, ratings, evaluationTypes, selectedEmployee }) {
  ...
  useEffect(() => {
    const fetchEvaluationDetails = async () => {
      try {
        ...
        const selectedQuestions = questionsResponse.data.questions || [];

        // Mettre à jour l'état avec les questions
