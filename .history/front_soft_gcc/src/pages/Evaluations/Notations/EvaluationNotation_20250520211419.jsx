...
const EvaluationNotation = () => {
  ...
  const generatePDFAfterValidation = () => {
    ...
    if (pdfGenerationFunctionRef.current && typeof pdfGenerationFunctionRef.current === 'function') {
      try {
        console.log("Exécution de la fonction de génération PDF");
        // Cette fonction retourne le nom du fichier généré ou null
      ...
      console.error("Fonction de génération PDF non disponible ou non valide");
      // Alternative : tenter d'appeler directement la fonction du composant Step3
      if (currentStep === 3) {
        console.log("Tentative de génération directe du PDF");
        // Essayer de forcer un nouveau rendu pour s'assurer que Step3 transmet sa fonction
