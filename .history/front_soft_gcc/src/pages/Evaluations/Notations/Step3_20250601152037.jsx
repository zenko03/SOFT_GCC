...
const Step3 = ({ ratings, average, evaluationId, validationData, onValidationChange }) => {
  ...
  useEffect(() => {
    const setupCompetenceNames = () => {
      try {
        // Utiliser directement un mapping statique des compétences
        // basé sur les données fournies par l'utilisateur
        const competenceMapping = {
          1: "Maîtrise avancée de JavaScript ES6+ avec manipulation du DOM et gestion des événements",
          2: "Développement d'interfaces utilisateur réactives avec React et gestion d'état (Redux/Context)",
          3: "Création d'applications single-page avec Angular et TypeScript",
          4: "Développement d'interfaces modernes avec Vue.js et Vuex",
          5: "Gestion de versions et collaboration avec Git, GitHub et workflows de développement",
          6: "Tests unitaires et d'intégration avec Jest et Testing Library",
          7: "Collaboration efficace en équipe avec méthodologies agiles",
          8: "Communication claire des spécifications techniques aux parties prenantes",
          9: "Créativité dans la conception d'interfaces utilisateur innovantes",
          10: "Développement d'applications robustes en Python avec frameworks Django/Flask",
          11: "Programmation orientée objet avancée en C# avec .NET Framework/Core",
          12: "Développement d'applications d'entreprise en Java avec Spring Boot",
          13: "Création d'applications web dynamiques en PHP avec Laravel/Symfony",
          14: "Développement de microservices performants en Go",
          15: "Architecture et développement avec Spring Framework et Spring Security",
          16: "Développement d'applications .NET avec Entity Framework et ASP.NET",
          17: "Création d'APIs REST robustes avec Django REST Framework",
          18: "Conception et implémentation d'APIs REST et SOAP sécurisées",
          19: "Maîtrise des workflows Git et intégration continue",
          20: "Conception et optimisation de bases de données relationnelles SQL",
          21: "Développement full-stack JavaScript avec Node.js et frameworks front-end",
          22: "Intégration Python back-end avec interfaces utilisateur modernes",
          23: "Développement d'applications complètes avec React et APIs REST",
          24: "Architecture d'applications Java avec Spring Boot et interfaces web",
          25: "Création d'applications web complètes avec Django et templates modernes",
          26: "Conception et implémentation d'architectures API-first",
          27: "Gestion complète du cycle de vie de développement avec Git"
        };
        
        // S'assurer que toutes les questions ont un mapping
        const updatedMapping = { ...competenceMapping };
        
        // Pour les questions dont l'ID de compétence n'est pas dans notre mapping,
        // utiliser un libellé générique
        selectedQuestions.forEach(question => {
          if (question.competenceLineId && !updatedMapping[question.competenceLineId]) {
            updatedMapping[question.competenceLineId] = `Compétence ${question.competenceLineId}`;
          }
        });
        
        setCompetenceNames(updatedMapping);
        console.log('Mapping des compétences appliqué:', updatedMapping);
      } catch (err) {
        console.error('Erreur lors de la configuration des noms de compétences:', err);
      }
    };
    
    setupCompetenceNames();
  }, [selectedQuestions]);
