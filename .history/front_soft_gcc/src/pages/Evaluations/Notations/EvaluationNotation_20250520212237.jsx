  ...
  const generatePDFAfterValidation = () => {
    ...
    if (pdfGenerationFunctionRef.current && typeof pdfGenerationFunctionRef.current === 'function') {
      try {
        ...
        // Extraire la fonction réelle si c'est une fonction qui retourne une fonction
        const pdfFunction = typeof pdfGenerationFunctionRef.current() === 'function' 
          ? pdfGenerationFunctionRef.current() 
          : pdfGenerationFunctionRef.current;
          
        // Exécuter la fonction de génération PDF
        console.log("Type de la fonction de génération:", typeof pdfFunction);
