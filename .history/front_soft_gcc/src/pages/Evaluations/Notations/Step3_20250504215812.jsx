    ...
    <div className="step3-container">
      ...
      <div className="competence-results-section">
        ...
        {loadingCompetences ? (
          ...
          <div className="alert alert-info mt-3" role="alert">
            <p>Aucun résultat par compétence disponible pour cette évaluation.</p>
      ...
      <div className="validation-section">
        ...
        <div className="alert alert-info">
          <strong>Information :</strong> Le calcul des résultats par compétence s&apos;effectue lors de la validation finale de l&apos;évaluation.
          C&apos;est pourquoi ils peuvent ne pas être visibles avant cette étape.
        </div>
