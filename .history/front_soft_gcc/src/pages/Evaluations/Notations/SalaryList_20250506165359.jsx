...
function SalaryList() {
  ...
  const getSortIcon = (columnName) => {
    const iconStyle = {
      ...styles.sortIcon,
      ...(sortConfig.key === columnName ? styles.sortIconActive : {})
    };
            ...
            <div className="card-body">
              ...
              <table className="table table-striped">
                <thead>
                  <tr>
                    <th>Employee</th>
                    <th style={styles.sortable} onClick={() => requestSort('name')}>
                      Nom
                      {getSortIcon('name')}
                    </th>
                    <th style={styles.sortable} onClick={() => requestSort('position')}>
                      Poste
                      {getSortIcon('position')}
                    </th>
                    <th style={styles.sortable} onClick={() => requestSort('evaluationDate')}>
                      Dates d&apos;évaluation 
