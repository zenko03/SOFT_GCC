...
const Step1 = ({ evaluationId, setRatings }) => {
  ...
  // Simplifiez à un seul critère si vous préférez une note globale
  // Ou gardez les 3 si une évaluation détaillée est nécessaire
  const evaluationCriteria = [
    { id: 'global', label: 'Note globale' }
    // Décommentez si vous voulez garder l'évaluation détaillée
