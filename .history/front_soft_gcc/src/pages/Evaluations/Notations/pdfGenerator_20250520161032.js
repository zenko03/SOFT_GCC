...
// Import du logo mais avec un try-catch
let softwellLogo;
try {
  softwellLogo = require('../../../assets/images/Logo/softwellogo.png');
} catch (err) {
  console.error("Erreur lors de l'import du logo:", err);
  softwellLogo = null;
}
...
export const generateEvaluationPDF = (
  ...
  try {
    ...
    // Logo - Simplifié pour éviter les problèmes asynchrones
...
export const downloadEvaluationPDF = (
  ...
  return generateEvaluationPDF(
    ...
    validationData, 
    trainingSuggestions,
    false // Ne pas prévisualiser, télécharger directement
  );
};
