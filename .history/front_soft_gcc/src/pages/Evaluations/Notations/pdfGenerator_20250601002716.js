...
const generatePDFContent = async (
  ...
  try {
    ...
    const data = questionsEntries.map(([, question]) => {
      ...
      const competence = question.competence || question.competenceName || ''; // Essayer les deux noms possibles
      ...
      } else if (question.comments !== undefined) {
        commentText = question.comments;
      } else if (question.remarque !== undefined) {
        commentText = question.remarque;
      } else if (question.commentaire !== undefined) {
