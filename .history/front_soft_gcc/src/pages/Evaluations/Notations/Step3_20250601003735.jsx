        ...
        if (competencesData) {
          ...
          if (Array.isArray(competencesData)) {
            competencesData.forEach(comp => {
              ...
              const name = comp.name || comp.competenceName || comp.description || comp.label || `Compétence ${id}`;
              if (id) namesMap[id] = name;
            });
          } else {
          ...
          // Ajouter manuellement quelques compétences courantes basées sur l'image montrée
          namesMap[21] = namesMap[21] || "Développement Full Stack";
          namesMap[22] = namesMap[22] || "Adaptabilité Technique";
          namesMap[23] = namesMap[23] || "Backend Python";
          namesMap[24] = namesMap[24] || "React";
          namesMap[25] = namesMap[25] || "Spring Boot";
          
          setCompetenceNames(namesMap);
          console.log('Mapping des compétences récupéré:', namesMap);
        } else {
