...
const Step3 = ({ ratings, average, evaluationId, validationData, onValidationChange, onGeneratePDF }) => {
  console.log("*** Rendu du composant Step3 (sans génération PDF automatique) ***");
  ...
  useEffect(() => {
    ...
    console.log("*** Enregistrement de la fonction de génération PDF (SANS EXÉCUTION) ***");
    ...
    const generatePdfOnDemandOnly = () => {
      console.log("*** EXÉCUTION MANUELLE DE LA FONCTION DE GÉNÉRATION PDF ***");
    ...
    // IMPORTANT: Nous passons UNE FONCTION QUI RETOURNE une fonction
    // pour empêcher l'exécution automatique
    onGeneratePDF(() => {
      console.log("*** Fonction wrapper appelée, retournant la fonction de génération PDF ***");
      return generatePdfOnDemandOnly;
    });
