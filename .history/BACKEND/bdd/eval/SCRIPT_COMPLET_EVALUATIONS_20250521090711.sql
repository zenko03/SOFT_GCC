...
-- Création de la table Users (nécessaire même si on va préférer Employee après)
...
BEGIN
    ...
    BEGIN
        ...
        PRINT 'Contrainte FK_Users_Employee ajoutée avec succès';
    END
...
-- ====================================================
PRINT '======================================================================';
PRINT 'SCRIPT COMPLET DU MODULE D''ÉVALUATION EXÉCUTÉ AVEC SUCCÈS';
PRINT '';
PRINT 'NOTES IMPORTANTES:';
PRINT '1. Ce script suppose que la table Employee et la vue v_employee_position existent déjà';
PRINT '2. Les anciennes colonnes userId, UserId sont conservées pour compatibilité';
PRINT '3. Les nouvelles colonnes employeeId, EmployeeId sont prévues pour la transition';
PRINT '4. Si besoin, exécuter une migration manuelle des données de Users vers Employee';
PRINT '======================================================================'; 