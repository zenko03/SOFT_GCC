    ...
    public class EvaluationService
    {
            ...
            string generalEvaluation)
        {
            ...
            foreach (var rating in ratings)
            {
                ...
                // Détecter si nous avons un DTO avec des critères détaillés
                // (Cette partie serait idéalement implémentée avec un DTO spécifique,
                // mais on utilise l'approche simplifiée par souci de compatibilité)
                bool hasDetailedCriteria = false;
                string jsonRating = ratingValue.ToString();
                ...
                if (existingResponsesDict.TryGetValue(questionId, out var existingResponse))
                {
                    ...
                    existingResponse.ResponseValue = jsonRating;
                ...
                else
                {
                    ...
                    var response = new EvaluationResponses
                    {
                        ...
                        ResponseType = hasDetailedCriteria ? "MULTI_CRITERIA" : "SCORE",
                        ResponseValue = jsonRating,
