        ...
        public async Task UpdateEmployeeSkillsAfterEvaluation(int evaluationId)
        {
            try
            {
                ...
                foreach (var result in competenceResults)
                {
                    try
                    {
                        // Récupérer la CompetenceLine sans inclure les relations
                        ...
                        // Récupérer le SkillPosition séparément
                        var skillPosition = await _context.Set<SkillPosition>()
                        ...
                        else
                        {
                            ...
                            int domainSkillId = firstDomain.DomainSkillId;
