        ...
        public async Task UpdateEmployeeSkillsAfterEvaluation(int evaluationId)
        {
            try
            {
                ...
                foreach (var result in competenceResults)
                {
                    ...
                    var skillPosition = await _context.Skill_position
                    ...
                    var existingSkill = await _context.Employee_skill
                    ...
                    if (existingSkill != null)
                    {
                        ...
                        _context.Employee_skill.Update(existingSkill);
                    ...
                    else
                    {
                        ...
                        await _context.Employee_skill.AddAsync(newEmployeeSkill);
