...
namespace soft_carriere_competence.Application.Services.Evaluations
{
    public class EvaluationService
    {
        ...
        // Méthode améliorée pour récupérer les questions sélectionnées avec le temps maximum
        public async Task<IEnumerable<dynamic>> GetSelectedQuestionsWithDetailsAsync(int evaluationId)
        {
            return await _context.evaluationSelectedQuestions
                .Where(esq => esq.EvaluationId == evaluationId)
