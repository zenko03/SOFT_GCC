    ...
    string? sortDirection = null)
        {
            ...
            // Éliminer les doublons en groupant par EmployeeId
            // Récupérer d'abord les IDs uniques puis filtrer
            var uniqueEmployeeIds = await query
                .Select(e => e.EmployeeId)
                .Distinct()
                .ToListAsync();
                
            // Filtrer pour n'obtenir que le premier employé pour chaque ID unique
            query = query.Where(e => uniqueEmployeeIds.Contains(e.EmployeeId));
