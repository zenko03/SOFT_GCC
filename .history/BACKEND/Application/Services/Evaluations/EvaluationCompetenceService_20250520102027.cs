                ...
                foreach (var result in competenceResults)
                {
                    try
                    {
                        ...
                        else
                        {
                            ...
                            try
                            {
                                // CETTE PARTIE CAUSE PROBABLEMENT L'ERREUR - NE PAS UTILISER LES REQUÊTES LINQ COMPLEXES
                                // Récupérer un domaine de compétence existant
