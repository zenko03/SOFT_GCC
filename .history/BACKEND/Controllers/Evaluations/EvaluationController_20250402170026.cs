...
namespace soft_carriere_competence.Controllers.Evaluations
{
	...
	public class EvaluationController : ControllerBase
	{
			...
			try
			{
				...
				var selectedQuestions = await _context.evaluationSelectedQuestions
					...
					.Select(sq => new
					{
						...
						maxTimeInMinutes = sq.SelectedQuestion.MaxTimeInMinutes,
		...
		[HttpPost("{evaluationId}/questions/{questionId}/time")]
		public async Task<IActionResult> SaveQuestionTime(int evaluationId, int questionId, [FromBody] int timeSpent)
		{
			try
			{
				var response = await _responseService.SaveQuestionTimeAsync(evaluationId, questionId, timeSpent);
				return Ok(response);
			}
			catch (Exception ex)
			{
