...
const EvaluationInterviews = () => {
    ...
    const { user, loading: userLoading } = useUser (); // Récupération de l'objet utilisateur et de l'état de chargement
    ...
    // Vérification de l'utilisateur lors du chargement du composant
    useEffect(() => {
        if (!state) {
        ...
        if (userLoading) {
            return; // Ne rien faire si le contexte utilisateur est en cours de chargement
        }
        ...
        setLoading(false); // Utilisateur chargé, fin du chargement
    ...
    // Rendu conditionnel pour le chargement et l'absence d'utilisateur
