...
const EvaluationFill = ({ extractedData, interview }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            // Construire le corps de la requête en respectant la structure DTO attendue
            const requestBody = {
                dto: {
                    managerApproval: null, // Explicitement NULL
                    directorApproval: null, // Explicitement NULL
                    notes: notes,
                },
            };
