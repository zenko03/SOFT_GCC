...
const EvaluationFill = ({ extractedData, interview }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            // Inclure les champs seulement si des valeurs sont spécifiées
            if (evaluationData.managerApproval !== undefined) {
                requestBody.managerApproval = evaluationData.managerApproval;
            }
            if (evaluationData.directorApproval !== undefined) {
                requestBody.directorApproval = evaluationData.directorApproval;
            }
