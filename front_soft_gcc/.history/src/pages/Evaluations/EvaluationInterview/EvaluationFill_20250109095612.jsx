...
const EvaluationFill = ({ extractedData, interview }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const requestBody = {
                Notes: notes,
                managerApproval: evaluationData.managerApproval ?? null, // Assigner null si non défini
                directorApproval: evaluationData.directorApproval ?? null, // Assigner null si non défini
            };
