              ...
              <tbody>
                {filteredEmployees.length > 0 ? (
                  filteredEmployees.map((employee) => {
                    // Vérifiez si le rôle est Manager ou Directeur
                    const userRole = getUserRole(); // Fonction à implémenter pour récupérer le rôle de l'utilisateur connecté
                    const isManager = userRole === "Manager";
                    const isDirector = userRole === "Directeur";

                    // Vérifiez les conditions pour afficher les boutons
