...
function EvaluationInterviewHome() {
  ...
  const handleOpenModal = () => {
    ...
    setEvaluationDetails({
      ...
      participants: [
        ...
        ...selectedEmployeesWithoutDate.map(emp => emp.employeeId),
        // Ajouter les managers ou directeurs par défaut
        ...participantsList
          .filter(participant => participant.isDefault) // Filtrer les participants par rôle
  ...
  const handleMassPlanning = async () => {
    try {
      ...
      console.log('Participants:', evaluationDetails.participants);
                        ...
                        <td>
                          <input
                            ...
                            onChange={() => {
                              ...
                              fetchSelectedEmployee(employee.employeeId); // Récupérer l'employé sélectionné
                            }}
                          />
                        </td>
                        <td>
                  ...
                  <form>
                    ...
                    <ParticipantsSelector
                      ...
                      setSelectedParticipants={(participants) => {
                        // Filtrer et valider les données si nécessaire
                        setEvaluationDetails((prevState) => ({
                          ...prevState,
                          participants: participants.filter((p) => typeof p === 'number'),
                        }));
                      }}
                    />
                  </form>
