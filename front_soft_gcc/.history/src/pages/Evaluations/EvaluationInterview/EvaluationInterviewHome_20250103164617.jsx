  ...
  return (
    <Template>
      <div className="salary-list-planning">
        <h4 className="title">FORYYYY EEE</h4>
                ...
                <div className="modal-body">
                  <form>
                    ...
                    <ParticipantsSelector
                      ...
                      fetchSelectedEmployee={fetchSelectedEmployee}
                      selectedEmployeeId={evaluationDetails.employeeId} // Assurez-vous que l'ID de l'employé soit passé ici
                    />
