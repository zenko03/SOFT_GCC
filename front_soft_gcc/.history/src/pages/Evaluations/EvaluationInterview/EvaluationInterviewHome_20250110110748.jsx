                  ...
                  filteredEmployees.map((employee) => {
                    ...
                    return (
                      <tr key={employee.employeeId}>
                        ...
                        <td>
                          {employee.interviewStatus === 25 ? ( // Affiche "En attente de validation"
                            <span className="text-warning">En attente de validation</span>
                          ) : interviewCompleted ? ( // Affiche "Entretien terminé"
                            <span className="text-success">Entretien terminé</span>
                          ) : isRH ? ( // Actions spécifiques au rôle RH
                            <>
                              {isValidInterviewDate(employee.interviewDate) ? (
                                <button
                          ...
                          ) : isManager && managerValidated ? ( // Manager : Affiche "Déjà validé"
                            <span className="text-info">Déjà validé</span>
                          ) : isDirector && directorValidated ? ( // Directeur : Affiche "Déjà validé"
                            <span className="text-info">Déjà validé</span>
                          ) : canManagerValidate || canDirectorValidate ? ( // Manager ou Directeur : Affiche "Valider"
                            <button
                              className="btn btn-primary btn-sm"
                              onClick={() => handleValidation(employee.employeeId)}
                            >
                          ...
                          ) : isToday ? ( // Affiche "Démarrer l'entretien" uniquement si la date est aujourd'hui
                            <button
