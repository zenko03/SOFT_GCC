...
function EvaluationInterviewHome() {
  ...
  // Ajoutez ce state au début de votre composant
  ...
  const handleError = useCallback((error, customMsg = "Une erreur est survenue. Veuillez réessayer.") => {
    ...
    toast.error(message); // Using toast for error notifications
  }, []);
  ...
  // Update selected participants in evaluationDetails
  useEffect(() => {
  ...
  // Fetch employees without evaluations
  ...
  return (
    <Template>
      <div className="salary-list-planning">
        ...
        {/* Error message */}
        {/* Using toast notifications instead of inline error messages */}
