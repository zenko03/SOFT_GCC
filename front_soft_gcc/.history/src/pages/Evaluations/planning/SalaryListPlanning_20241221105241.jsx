...
function SalaryListPlanning() {
  ...
  const fetchEvaluationTypes = async () => {
    try {
      ...
      setEvaluationTypes(response.data); // Mettre à jour l'état avec les types d'évaluations
    } catch (error) {
  ...
  const handleOpenModal = () => {
    fetchEvaluationTypes(); // Charger les types d'évaluations avant d'ouvrir le modal
    setShowModal(true);
  };
  ...
  return (
    <Template>
      {/* ... Autres parties du composant inchangées ... */}
