...
function SalaryListPlanning() {
  ...
  const fetchEvaluationTypes = async () => {
    try {
      ...
      setSelectedEvaluationType(evalResponse.data);
    } catch (error) {
                ...
                <div className="modal-body">
                  <form>
                    ...
                    <div className="form-group">
                      ...
                      <select className="evaluation-select" value={selectedEvaluationType || ''} onChange={fetchEvaluationTypes}>
                        <option value="" disabled>Sélectionnez un type</option>
                        {selectedEvaluationType.map(type => (
