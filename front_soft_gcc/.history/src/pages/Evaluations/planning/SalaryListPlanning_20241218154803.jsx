...
function SalaryListPlanning() {
  ...
  const handleFilterChange = (e) => {
    ...
    console.log("Nom du filtre:", name);
    console.log("Valeur brute:", value);
    console.log("Valeur parsée:", parsedValue);
    setFilters(prev => {
      console.log("Filtres avant mise à jour:", prev);
      const nextFilters = { ...prev, [name]: parsedValue };
      console.log("Filtres après mise à jour:", nextFilters);
      return nextFilters;
    });
  };
      ...
      <div className="salary-list-planning">
        ...
        <div className="filters">
          ...
          <select
            name="department"
            className="filter-select"
            value={filters.Department} // Par défaut, une chaîne vide si aucune sélection
            onChange={handleFilterChange}
          >
