  ...
  const fetchFilterOptions = async () => {
    try {
      const [positionsRes, departmentsRes] = await Promise.all([
        axios.get('https://localhost:7082/api/positions'), // Endpoint pour récupérer les postes
        axios.get('https://localhost:7082/api/departments'), // Endpoint pour récupérer les départements
      ]);
