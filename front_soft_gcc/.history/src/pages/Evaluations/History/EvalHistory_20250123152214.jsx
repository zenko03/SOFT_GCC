...
const EvaluationHistory = () => {
  ...
  useEffect(() => {
    const fetchEvaluations = async () => {
      if (!searchQuery && !filters.evaluationDate && !filters.position) return; // Ne pas faire de requête si les filtres sont vides
      setLoading(true);
      try {
        const response = await axios.get('https://localhost:7082/api/EvaluationHistory/evaluation-history-paginated', {
          params: { pageNumber: currentPage, pageSize, startDate: filters.evaluationDate, department: filters.position, employeeName: searchQuery },
        });
          ...
          <div className="card-header">
            ...
            <div className="btn-group">
              <button
                ...
                onClick={() => handleExport("pdf")} // Export PDF
              ...
              <button
                className="btn btn-outline-primary btn-sm"
                onClick={() => handleExport("excel")} // Export Excel
              ...
              <button
                ...
                onClick={() => handleExport("csv")} // Export CSV
