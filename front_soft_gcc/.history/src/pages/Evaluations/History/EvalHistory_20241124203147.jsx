...
const EvalHistory = () => {
  ...
  const [selectedEmployee, setSelectedEmployee] = useState(null); // Pour stocker les détails de l'employé sélectionné
  ...
  const mockEmployees = [
    ...
    { 
      ...
      status: 'Terminé', 
      score: 4.2,
      evaluationType: 'Évaluation par compétence',
      evaluators: ['Superviseur : Bob White', 'Directeur : Alice Brown'],
    },
  ];
            ...
            <div className="modal-dialog modal-dialog-centered" role="document">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <p><strong>Date d'évaluation :</strong> {selectedEmployee.evaluationDate}</p>
                  <p><strong>Type d'évaluation :</strong> {selectedEmployee.evaluationType}</p>
