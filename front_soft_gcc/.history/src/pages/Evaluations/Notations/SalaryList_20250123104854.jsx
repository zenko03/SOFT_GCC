...
function SalaryList() {
  ...
  useEffect(() => {
    const fetchEmployees = async () => {
      try {
        const response = await axios.get('https://localhost:7082/api/User/details');
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      ...
      case 3:
        return <Step3 ratings={ratings} average={calculateAverage()} evaluationId={selectedEmployee.evaluationId} />;
      default:
        return null;
    }
  };
