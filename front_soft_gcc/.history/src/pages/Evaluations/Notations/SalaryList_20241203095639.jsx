...
function SalaryList() {
  ...
  const handleEvaluationTypeChange = async (event) => {
    console.log("juste dans handleEvaluations");
    ...
    console.log("Type d'évaluation sélectionné :", typeId);
    console.log("PostId de l'employé sélectionné :", selectedEmployee.postId);
