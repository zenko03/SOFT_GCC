...
function SalaryList() {
  ...
  const saveEvaluationResults = async () => {
    ...
    const data = {
      evaluationId: selectedEvaluationType.EvaluationTypeId, // ID du type d'évaluation sélectionné
    ...
    console.log("type : ", data.evaluationId);
    console.log("overallScore : ", data.overallScore); // Vérifiez la présence d'un overallScore
