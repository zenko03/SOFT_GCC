...
function QuestionEvaluation() {
    ...
    const filteredQuestions = sortedQuestions.filter(question => {
        const matchesEvaluationType = filterEvaluationType ? question.evaluationTypeId === filterEvaluationType : true;
        const matchesPost = filterPost ? question.postId === filterPost : true;
    ...
    return (
        <Template>
            <div className="container mt-4">
                ...
                // Ajoutez cette section dans le return() juste avant la liste des questions
                <div className="mb-4">
                    <h4>Filtrer les Questions</h4>
                    <div className="form-row">
                    ...
                    {filteredQuestions.map((question) => (
                        <li key={question.questiondId} className="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div>Poste: {posts.find(post => post.postId === question.postId)?.title}</div>
                            </div>
                            <div>
