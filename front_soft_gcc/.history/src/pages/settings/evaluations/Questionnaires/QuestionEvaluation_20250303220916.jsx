...
function QuestionEvaluation() {
    ...
    const fetchQuestions = async () => {
        try {
            const response = await axios.get('/api/evaluation/questionsAll'); // Adjust the API endpoint as needed
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (currentQuestion) {
                ...
                await axios.put(`/api/evaluation/questions/${currentQuestion.questiondId}`, formData);
            } else {
                // Create new question
                await axios.post('/api/evaluation/questions', formData);
            }
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`/api/evaluation/questions/${id}`);
            fetchQuestions(); // Refresh the list
        } catch (error) {
