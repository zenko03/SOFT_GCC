...
function EstablishmentCrudPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        setError(null);
        try {
            await axios.post(urlApi('/Establishment'), formData);
            fetchData();
    ...
    const handleSubmitModified = async (e) => {
        ...
        setError(null);
        try {
            await axios.put(urlApi(`/Establishment/${idItem}`), formData);
            fetchData();
        } catch (error) {
            setError(`Erreur lors de l'insertion : ${error.response?.data || error.message}`);
        } finally {
    ...
    return (
        <Template>
            ...
            <div className="col-lg-12 skill-header">
                ...
                <h4 className="skill-title">ENTITÉ ETABLISSEMENT</h4>
            </div> 
            {isLoading && <Loader />}
                                ...
                                <form className="forms-sample" onSubmit={handleSubmitModified}>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="button-save-profil">
                                            ...
                                            <button type="reset" className="btn btn-light btn-fw" onClick={() => setFormData({ establishmentName: '' })}>Annuler</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
